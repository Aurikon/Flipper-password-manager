...
void (*const fpm_scene_on_enter_handlers[])(void*) = {
    ...
    fpm_scene_read_passwords_show_on_enter, /*FPM_READ_PASSWORDS_SHOW*/
};
bool (*const fpm_scene_on_event_handlers[])(void*, SceneManagerEvent) = {
    ...
    fpm_scene_read_passwords_show_on_event, /*FPM_READ_PASSWORDS_SHOW*/
...
void (*const fpm_scene_on_exit_handlers[])(void*) = {
    ...
    fpm_scene_read_passwords_show_on_exit, /*FPM_READ_PASSWORDS_SHOW*/
